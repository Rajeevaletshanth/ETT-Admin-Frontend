...
const dropdownItemList = [
	...
	{ label: 'Account Setting', path: '/app/account/settings/password', icon: <HiOutlineCog /> },
...
export const UserDropdown = ({ className }) => {
	...
	const UserAvatar = (
		<div className={classNames(className, 'flex items-center gap-2')}>
			<Avatar size={32} shape="circle" src={profileImg} />
			...
			<Dropdown menuStyle={{minWidth: 240}} renderTitle={UserAvatar} placement="bottom-end">
				<Dropdown.Item variant="header">
					<div className="py-2 px-3 flex items-center gap-2">
						<Avatar shape="circle" src={profileImg} />
						<div>
